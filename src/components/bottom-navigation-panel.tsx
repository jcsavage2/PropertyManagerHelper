...
export const BottomNavigationPanel = () => {
  ...
  return (
    <div className="fixed -bottom-1 left-0 z-50 w-full border-t border-gray-200 dark:bg-gray-700 dark:border-gray-600" style={{ height: '8dvh' }}>
      <div className="grid h-full w-full grid-cols-4 mx-auto font-medium">
        <Link
          ...
          className={`inline-flex flex-col items-center justify-center hover:bg-gray-50 dark:hover:bg-gray-800 group ${
            userType !== ENTITIES.PROPERTY_MANAGER && 'col-span-4'
          }`}
        >
