...
import { FinishFormRequest } from "../new-request"
...
export default async function handler(req: NextApiRequest, res: NextApiResponse<Data>) {
  ...
  const { text, messages, workOrder } = body
  ...
  const prompt: ChatCompletionRequestMessage = {"role": "system", "content": `CONTEXT: examine this JSON: ${JSON.stringify(workOrder)}
