...
export default async function handler(req: NextApiRequest, res: NextApiResponse<ApiResponse>) {
  try {
    ...
    const { pk, sk, technicianEmail, pmEmail } = body;
    ...
    await sendgrid.send({
      ...
      subject: `Technician ${technicianEmail} opened WO ${shortenedWorkOrderIdString}`,
      ...
      <body>
        <div class="container" style="margin-left: 20px;margin-right: 20px;">
          <h1>Work Order ${shortenedWorkOrderIdString} opened by technician ${technicianEmail}</h1>
